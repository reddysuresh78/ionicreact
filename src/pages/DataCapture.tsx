...
import {
    IonContent, IonPage ,IonCard, IonCardContent, IonToast, IonHeader, IonToolbar, IonButton, IonLabel, IonGrid, IonRow, IonCol, IonDatetime,  IonTitle, IonSpinner
} from '@ionic/react';
...
const DataCapture: React.FC = (props: any) => {
    ...
    useEffect(() => {
        if (serverData != null) {
            ...
            props.history.push({ pathname: '/nplhome', state: serverData });
        }
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [serverData]);
